...
public class SearchSeeds12 : MonoBehaviour
{
    ...
    [SerializeField] DownloadController12 _downloadController12;
    ...
    public void CallEnableUnityEvent12()
    {
    ...
    public void ListAdded12()
    {
        ...
        {
            case "All":
                foreach (Transform item12 in _generator12.modsList12)
            ...
            case "New":
                foreach (Transform item12 in _generator12.newCardList12)
                    searchList12.Add(item12);
                break;
