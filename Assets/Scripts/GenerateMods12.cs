...
public class GenerateMods12 : MonoBehaviour
{
    ...
    private async void SetParamCard12(Dictionary<string, Dictionary<string, string>> keyValues12, string categry12)
    {
        ...
        {
            string name12 = var4ik12.Value[keys12.ModNameKey12].Split('/')[0];
            string desct12 = var4ik12.Value[keys12.ModDescription12];
            ...
            g12.name = var4ik12.Value[keys12.ModNameKey12].Split('/')[0];
            g12.GetComponent<Item12>().myDecription12 = desct12;
            string fileNameFile = var4ik12.Value[keys12.ModFile12].Split('/')[1];
            g12.GetComponent<Item12>().myNameFile12 = fileNameFile;
            g12.GetComponent<Item12>().myFile12 = await GetFirebaseStorageLink12(keys12.ModPathToBak12 + fileNameFile);
            g12.GetComponent<Item12>().category12 = categry12;
           
            string fileNameIcon = var4ik12.Value[keys12.ModIconKey12].Split('/')[1];
            g12.GetComponent<IconController12>().imageName12 = fileNameIcon;
            g12.GetComponent<IconController12>().imageURL12 = await GetFirebaseStorageLink12(keys12.ModPathToBak12 + fileNameIcon);
    ...
    {
        SetParamCard12(_content12.U1kn.Anime, keys12.ModCategory_112);
        SetParamCard12(_content12.U1kn.Princess, keys12.ModCategory_212);
        SetParamCard12(_content12.U1kn.Mermaid, keys12.ModCategory_312);
        SetParamCard12(_content12.U1kn.EvilGirl, keys12.ModCategory_412);
        SetParamCard12(_content12.U1kn.WolfGirls, keys12.ModCategory_512);
        SetParamCard12(_content12.U1kn.ZombieGirl, keys12.ModCategory_612);
        SetParamCard12(_content12.U1kn.WonderWoman, keys12.ModCategory_712);
        SetParamCard12(_content12.U1kn.Girls, keys12.ModCategory_812);
        SetParamCard12(_content12.U1kn.Princess0, keys12.ModCategory_912);
        SetParamCard12(_content12.U1kn.Wings, keys12.ModCategory_1012);
        SetParamCard12(_content12.U1kn.Angel, keys12.ModCategory_1112);
    }
}
